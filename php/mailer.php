...
If (isset($_POST['txtdest']))
{
    ...
    $mailer->Host = 'smtp.seudominio.com.br'; //smtp.dominio.com.br
    $mailer->SMTPAuth = true; //define se haverá ou não autenticação no SMTP
    $mailer->Username = 'CAIXAPOSTAL'; //Informe o e-mai o completo
    $mailer->Password = 'SENHACAIXAPOSTAL.'; //Senha da caixa postal
    $mailer->FromName = $assunto; //Nome que será exibido para o destinatário
    $mailer->From = 'CAIXAPOSTAL'; //Obrigatório ser a mesma caixa postal indicada em "username"
